#Find all the edges that lie on any shortest path between a given pair of vertices (n1, n2).
import sys, os.path
...
def edges_on_shortest_path(n, edges, n1, n2):
	node = [n1, n2]
	arr = []
	for i in range(2):
...
def main():
	...
	for i in range(m):
		...
		edges[b] += [a]
	n1, n2 = In()
	edges_on_shortest_path(n, edges, n1, n2)
